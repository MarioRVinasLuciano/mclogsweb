    ...
    return (
        <div className="h-screen w-full font-Encode-Sans pt-20 px-10 sm:px-10 md:px-20 lg:px-40 xl:px-40">
            <div className="h-auto w-full py-12">
                ...
                <div className="pt-20">
                    <p className="text-2xl">Su privacidad es muy importante para nosotros. En consecuencia, hemos desarrollado esta Política para que comprenda cómo recopilamos, usamos, comunicamos, divulgamos y hacemos uso de la información personal. Lo siguiente describe nuestra política de privacidad.</p>
