...
export default function Footer(){
    ...
    let Acceso_rapido = [
      ...
      let Enlaces = [
        { name: "Politica de Privacidad", link: "/nosotros" },
        { name: "Politica de Seguridad", link: "/servicios" },
        { name: "Terminos de uso", link: "/agentes"},
      ];

    return (
        <footer className="bottom-0 w-full pt-6 bg-white">
                <div className="flex justify-center items-center h-auto w-full">
                    <div className="grid grid-rows-4 sm:grid-rows-4 md:grid-rows-4 lg:grid-rows-1 grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4 gap-x-6 px-16">
                        ...
                        <div className="h-auto col-span-1 lg:col-span-1 row-start-1 sm:row-start-1 md:row-start-1 lg:row-start-1">
                            <div>
                                <img className="h-24 w-50" src={mclogo} alt="" />
                            </div>
                            <div className="pt-4">
                                <p className="text-sm text-gray-500">Nacemos en el 2005 de la inquietud de crear valor en el proceso de gestión de la cadena de suministro, viendo oportunidades en el sector logístico de mejor flujo de información.</p>
                            </div>
                            <div className="flex flex-row py-6">
                                ...
                                <div className="px-4">
                                <div className="rounded-full h-10 w-10 content-center border-slate-300 border">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-10 w-10 p-2 text-gray-500">
                            ...
                            <div className=" h-72 w-auto pb-10 text-start">
                                <div className="w-32">
                                    { Acceso_rapido.map((link, id) => (
                                          ...
                                          <div className="py-2">
                                          <p key={id} className="text-sm"><Link to={link.link}>{link.name}</Link></p>
                                      </div>  
                                    ))}
                                </div>
                            </div>
                            ...
                            <div className=" h-72 w-auto  pb-10 text-start">
                                <div className="w-full">
                                    { Enlaces.map((link) => (
                                          ...
                                          <div className="py-2">
                                          <p className="text-sm"><Link to={link.link}>{link.name}</Link></p>
                                      </div>  
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="text-start">
                            ...
                            <div className="h-72 w-auto text-center">
                                <div className="text-start pt-4">
                                    ...
                                    <div className="py-2">
                                        <p className="text-sm">Sabados 8:00 am - 1:00 pm</p>
                                    </div>
                                    <div>
                                        <h2 className="text-md">Plataformas</h2>
                                    </div>
                                    <div className="py-2 gap-x-2 flex flex-row">
                                        <img className="h-6 w-6" src={apple} alt="" />
                                        <p className="text-sm">Disponible en google play</p>
                                    </div>
                                    <div className="py-2 gap-x-2 flex flex-row">
                                        <img className="flex h-6 w-6" src={android} alt="" />
                                        <p className="flex text-sm">Disponible en apple store</p>
                                    </div>
                                </div>
                            </div>
                        </div>
