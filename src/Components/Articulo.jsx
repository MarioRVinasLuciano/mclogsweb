                    ...
                    <div className='flex flex-row justify-between py-4 w-full'>
                        ...
                        <div className='relative flex flex-row items-center pt-4'>
                            ...
                            <button onClick={Comparte} className='flex'>
                                <p className='text-slate-500 pr-4 '>{t("share")}</p>
                            ...
                            {compartir === true ?
                                <div className='absolute top-32 sm:top-20 md:top-20 right-0 xl:right-0 h-44 w-32 bg-slate-100 flex flex-col gap-y-2 text-center items-start p-2 z-10'>

                                    <a className="flex items-center gap-x-2" href={`https://www.facebook.com/sharer/sharer.php?u=https://mclogshostingdemo.web.app/${contenido.oid}`}>
                                        <div>
                                    ...
                                    <a className="flex items-center gap-x-2" href="https://www.linkedin.com/shareArticle?mini=true&url=https://mclogshostingdemo.web.app&source=LinkedIn">
                                        <div>
                                    ...
                                    <a className="flex items-center gap-x-2" href={`https://twitter.com/intent/tweet?text=&amp;url=https://mclogshostingdemo.web.app/${contenido.oid}`}>
                                        <div>
                                    ...
                                    <a className="flex items-center gap-x-2" href={`whatsapp://send?text=${encodeURIComponent(`https://mclogshostingdemo.web.app/#/articulo/${contenido.oid}`)}`}>
                                        <div>
                                    ...
                                    <a className="flex items-center gap-x-2" href={`mailto:?subject=Noticia%20-%20MC%20Logistics&body=https://mclogshostingdemo.web.app/${contenido.oid}`}>
                                        <div>
                    ...
                    <div className='pt-10'>
                        <>
                            {canGoBack && (
                                <button
                                    onClick={() => navigate(-1)}
                                    className="btn relative inline-flex items-center justify-start overflow-hidden font-medium transition-all bg-slate-300 rounded hover:bg-white group py-1.5 px-2.5"
                                >
                                    ...
                                    <span className="relative w-full text-left text-bluemunsell transition-colors duration-300 ease-in-out group-hover:text-white">
                                        {t("goback")}
                                    </span>
                                </button>
                            )}
